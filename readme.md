...
| 9 | Midterm |  |  |  |
| 10 **(Current)** | Virtual Functions (Static VS Dynamic Binding) + Polymorphism + Abstraction | [Video18](https://youtu.be/APOSbeDyHLw) |  | ▸ Static VS Dynamic Binding <br> ▸ Redefine VS Override function <br> ▸ Pointer to object with inheritance <br> ▸ why we need virtual in destructor <br> ▸ Polymorphism <br> ▸ overloading VS Overriding | [Lab7-8](Labs/Lab7-8.pdf) |
